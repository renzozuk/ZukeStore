    ...
    <>
      ...
      <div className="main-content">
        ...
        <div className="products">
          ...
          <Product image="https://images.pexels.com/photos/296158/pexels-photo-296158.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" name="Sapatos" description="Este par de sapatos é muito mais do que um simples acessório; é uma expressão de estilo, conforto e funcionalidade." price={399.99} />
          <Product image="https://images.pexels.com/photos/683624/pexels-photo-683624.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" name="Despertador" description="Perfeito para despertar no início da manhã e não perder a hora de ir ao trabalho. Diferentes sons ou músicas podem ser usados para o despertador." price={55.90} />
          <Product image="https://images.pexels.com/photos/3428498/pexels-photo-3428498.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" name="Violão" description="Um instrumento musical de cordas, feito de madeira, com uma caixa de ressonância e braço longo. Suas seis cordas são tocadas com os dedos ou palheta, produzindo sons ricos e harmônicos." price={299.99} />
